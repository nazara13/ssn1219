...
/**
 * TbeditingSearch represents the model behind the search form of `app\models\Tbediting`.
 */
class TbeditingSearch extends Tbediting
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['nks', 'ruta1', 'ruta2', 'ruta3', 'ruta4', 'ruta5', 'ruta6', 'ruta7', 'ruta8', 'ruta9', 'ruta10', 'Total'], 'safe'],
        ];
    }
